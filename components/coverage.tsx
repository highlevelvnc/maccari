        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-[#94A3B8] mb-8" style={{ lineHeight: 1.7 }}>
              Com base em São Domingos de Rana, prestamos serviços em toda a Área Metropolitana de Lisboa. Deslocação rápida e atendimento personalizado em toda a área de cobertura.
            </p>
