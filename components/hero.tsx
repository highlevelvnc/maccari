...
export default function Hero() {
  ...
  const magneticWa = useMagnetic<HTMLAnchorElement>(10)
  const magneticCall = useMagnetic<HTMLAnchorElement>(8)
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center pt-24 pb-20 overflow-hidden">
      <HeroSpotlight targetSelector="#hero" />
        ...
        >
          ...
          <div className="w-full lg:w-[55%] flex flex-col gap-6">
            ...
            <div className={`flex flex-col sm:flex-row gap-3 fade-up delay-4 ${isVisible ? 'visible' : ''}`}>
              <a ref={magneticWa} href={waLink(WA_MESSAGES.general)} target="_blank" rel="noopener noreferrer" className="hero-cta-wa magnetic-cta">
              ...
              <a ref={magneticCall} href="tel:+351913973551" className="hero-cta-secondary magnetic-cta">
          ...
          <div className={`w-full lg:w-[45%] fade-up delay-3 ${isVisible ? 'visible' : ''}`}>
            <div className="hero-glass-card premium-border-glow">
