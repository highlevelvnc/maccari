...
/**
 * Fixed bottom mobile CTA bar. Hidden ≥768px via CSS.
 * Appears after the user scrolls past the hero (~300px) and slides
 * up with a spring. Whatsapp + Call buttons, both 48px tall.
 */
export default function MobileCtaBar() {
  ...
  return (
    <div className={`mobile-cta-bar ${visible ? 'visible' : ''}`} aria-hidden={!visible}>
      ...
      <a href={`tel:${BRAND.phoneRaw}`} className="cta-call" aria-label={`Ligar para ${BRAND.phone}`}>
